...
request = $.ajax({
    url: "https://automagok-grok.ap.qualcomm.com:9999/db/sp/?category__in=LV,QX,HQX,LV_LE",
    type: "GET",
    cache: false,
    crossDomain: true,
    datatype: "json",
...
request = $.ajax({
    url: "https://automagok-grok.ap.qualcomm.com:9999/db/build/",
    type: "GET",
    cache: false,
    crossDomain: true,
    datatype: "json",
...
function draw() {
        ...
        for(i = 0; i < len_sp; i++) {
			...
			lefts.splice(3, 0, "GVM ID "); 
			    ...
			    if(apps_id.indexOf('LV.') > -1 || apps_id.indexOf('QXA.') > -1) 
			        link.setAttribute('href', 'https://automagok-grok.ap.qualcomm.com:7070/source/xref/' + information[k]);
			    else
				link.setAttribute('href', 'https://automagok-grok.ap.qualcomm.com:7071/source/xref/' + information[k]);
			    link.innerHTML = information[k];
			    td_content.appendChild(link);
			}
        ...
        $(document).ready(function(){
			...
			var id;
				...
				request = $.ajax({
				    url: "https://automagok-grok.ap.qualcomm.com:9999/db/sp/"+ id +"/",
				    type: "PUT",
			...
			if(result_build[h]['name'] === $(this).prev().prev().html()) {
				...
				request = $.ajax({
				    url: "https://automagok-grok.ap.qualcomm.com:9999/db/build/"+ id +"/",
				    type: "PUT",
				    contentType: 'application/json; charset=utf-8',
				    datatype: "json",
				    async: true,
		...
		request = $.ajax({
	    	    url: "https://automagok-grok.ap.qualcomm.com:9999/db/sp/",
		    type: "GET",
		    datatype: "json",
		    success: reqGetResponseSP
		});
